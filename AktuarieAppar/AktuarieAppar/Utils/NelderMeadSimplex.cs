...
/// <summary>
/// Nelder–Mead method or downhill simplex method
/// original code from github.com/krystiankurylo/nelder-mead-simplex.git
/// Modified to handle additional arrays (  ,t, y) in objective function by Mats Holm 2018-12
/// </summary>

namespace AktuarieAppar.Utils.NSS
{
    public delegate double ObjectiveFunctionDelegate(double[] constants, int[] tt, double[] Y);
    ...
    public sealed class NelderMeadSimplex
    {
        ...
        public static RegressionResult Regress(SimplexConstant[] simplexConstants, int[] tt, double[] Y, double convergenceTolerance, int maxEvaluations, 
        ...
        /// <returns></returns>
        private static double[] _initializeErrorValues(Vector[] vertices, ObjectiveFunctionDelegate objectiveFunction, int[] tt, double[] Y)
        {
        ...
        private static double _tryToScaleSimplex(double scaleFactor, ref ErrorProfile errorProfile, Vector[] vertices, 
                                          double[] errorValues, ObjectiveFunctionDelegate objectiveFunction, int[] tt, double[] Y)
        {
        ...
        private static void _shrinkSimplex(ErrorProfile errorProfile, Vector[] vertices, double[] errorValues, 
                                      ObjectiveFunctionDelegate objectiveFunction, int[] tt, double[] Y)
        {
